  ...
  const projectCards = [
    {
      ...
      title: "Quorix -E-Commerce Platform",
    ...
    
    {
      ...
      title: "CodeVaxy - Coding Platform",
      description: "AI-powered Code translator For students And Instituations ",
      date: "In Progress",
